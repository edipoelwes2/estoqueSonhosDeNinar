...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 20 Unidades', 'size' => 'M', 'price' => 29.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 42 Unidades', 'size' => 'M', 'price' => 43.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 62 Unidades', 'size' => 'M', 'price' => 65.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Dia e Noite / Calça / 38 Unidades', 'size' => 'M', 'price' => 38.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 50 Unidades', 'size' => 'P', 'price' => 43.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 17 Unidades', 'size' => 'G', 'price' => 29.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 36 Unidades', 'size' => 'G', 'price' => 43.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Dia e Noite / Calça / 34 Unidades', 'size' => 'G', 'price' => 38.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Dia e Noite / Calça / 30 Unidades', 'size' => 'XG', 'price' => 38.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 32 Unidades', 'size' => 'XG', 'price' => 38.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 15 Unidades', 'size' => 'XG', 'price' => 29.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 28 Unidades', 'size' => 'XXG', 'price' => 43.00, 'created_at' => now(), 'updated_at' => now()],
            ['category_id' => 1, 'brand_id' => 2, 'description' => 'Super Seca / Calça / 13 Unidades', 'size' => 'XXG', 'price' => 29.00, 'created_at' => now(), 'updated_at' => now()],
